...
public:
    ...
    {
        // executed when a new image is published on the topic /usb_cam/image_raw
        // converts the ROS message into the opencv image format cv::Mat
    ...
    {
        // finds edges of an image in real time  using an inbuilt functionality of opencv
        ...
        // applies blurring to the image (filtering)
        cv::blur(src_gray, detected_edges, cv::Size(5, 5));
        // finds the edges in the filtered image
        ...
        // view the image with the detected corners
